...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50 px-4 animate-gradient font-sans">
            <div className="max-w-md w-full glassmorphism rounded-3xl p-8 shadow-2xl relative overflow-hidden mt-8 mb-8">
                ...
                <div className="text-center mb-8 relative z-10">
                    ...
                    <p className="text-slate-500 mt-2 font-medium">Join LearnPulse AI today</p>
                </div>
                ...
                <form onSubmit={handleRegister} className="space-y-4 relative z-10">
                    ...
                    <button 
                        type="submit" 
                        disabled={loading}
                        className="btn-premium w-full bg-indigo-600 hover:bg-indigo-500 text-white font-black py-3.5 rounded-xl shadow-[0_8px_20px_-6px_rgba(79,70,229,0.4)] mt-6 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {loading ? 'Creating Account...' : 'Sign Up'}
                    </button>
                </form>

                <p className="text-center mt-6 text-slate-600 font-medium relative z-10">
